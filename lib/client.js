...
export class GscoreClient {
    ...
    async dispatchCoreSend(msg) {
        ...
        const targetId = stringifyId(msg.target_id)
    ...
    async rememberQQBotMessageId(e) {
        ...
        const targetId = targetType === "direct" ? e.user_id : e.group_id
    ...
    async sendQQBotMessage(bot, targetType, targetId, message) {
        ...
        const data = targetType === "direct"
            ? { ...bot.fl?.get?.(targetId), self_id: this.selfId, bot, user_id: rawTargetId }
            : { ...bot.gl?.get?.(targetId), self_id: this.selfId, bot, group_id: rawTargetId }
        try {
