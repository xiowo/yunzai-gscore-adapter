...
export class GscoreClient {
    ...
    async sendYunzaiMessage(selfId, targetType, targetId, content) {
        ...
        const message = isQQBot ? await this.toQQBotMessage(content) : await toYunzaiMessage(content, this.config)
        if (!message.length) return null
        const ret = isQQBot
            ? await this.sendQQBotMessage(bot, targetType, targetId, message)
            : targetType === "direct"
